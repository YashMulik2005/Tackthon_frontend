                ...
                <div className=' relative rounded-lg  bg-white'>
                    ...
                    <section className=' w-32 h-32 absolute rounded-lg top-20 left-7'>
                        <img className='rounded-lg h-full w-full object-cover'
                            src={collegedata?.photo ? collegedata.photo : 'https://www.festivalsfromindia.com/wp-content/uploads/2022/04/VJTI-Mumbai.-Photo-VJTI-Mumbai-1_11zon.jpg'} alt='img' />
                    </section>
                </div>
            ...
            <div className=' grid grid-cols-1 md:grid-cols-2 gap-4'>
                <div className=' flex flex-col gap-2 md:h-[50vh] overflow-y-auto'>
                    ...
                    <div className=' flex flex-col gap-3'>
                        {dpt.length === 0 ? (
                            <div className=" flex justify-center items-center border rounded-xl px-3 bg-white">
                                <img src={photo} className=" w-36 h-36" />
                                <h1 className=" font-semibold">No Department added till now.</h1>
                            </div>
                        ) :
                            dpt?.map((item, index) => {
                ...
                <div className=' flex flex-col gap-2 md:h-[50vh] overflow-y-auto'>
                    ...
                    <div className=' flex flex-col gap-3'>
                        {project.length === 0 ? (
                            <div className=" flex justify-center items-center border rounded-xl px-2 bg-white">
                                <img src={photo} className=" w-36 h-36" />
                                <h1 className=" font-semibold">No proejct found</h1>
                            </div>
                        ) :
