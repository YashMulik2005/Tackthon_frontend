            ...
            <div className=' grid grid-cols-1 min-[580px]:grid-cols-[auto_1fr]  gap-6 justify-center cursor-pointer'>
                ...
                <div className=' flex gap-2 flex-col justify-start '>
                    ...
                    <div className=' flex flex-col min-[500px]:flex-row justify-between text-xs text-gray-500 mt-2 items-start max-[500px]:gap-1 min-[500px]:items-end'>
                        ...
                        <div className=' bg-[#57CC99] rounded-full bg-opacity-25 px-3 py-2 text-green-600  font-semibold cursor-pointer'
                            onClick={() => { navigate(`/project/${data._id}`) }}>Go to Project </div>
                    </div>
                </div>
